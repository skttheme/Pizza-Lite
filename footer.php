...
<div id="footer-wrapper">
    	...
    	<div class="container footer">
         ...
         <div class="copyright-wrapper">
        	<div class="container">
            	 <div class="design-by"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','pizza-lite');?><a href="<?php echo esc_url('https://www.sktthemes.org/product-category/restaurant/');?>" target="_blank">
        <?php esc_html_e('SKT Restaurant Themes','pizza-lite'); ?>
        </a></div>
                 <div class="clear"></div>
            </div>           
        </div>
